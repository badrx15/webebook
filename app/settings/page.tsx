    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={e => setForm(f => ({ ...f, defaultMargin: parseInt(e.target.value) || 0 }))}
                className="input-field"
              />
              <p className="text-xs text-[var(--text-secondary)] mt-1">
                Se usará para sugerir precios de venta
              </p>
            </div>
            <div>
        ...
        <div className="card space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-[var(--text-secondary)] mt-1">
              Los productos con stock igual o menor a este número se marcarán en amarillo
            </p>
          </div>
        </div>
      ...
      <div className="card border-red-200 space-y-4">
        ...
        <p className="text-sm text-[var(--text-secondary)]">
          Esto eliminará todos tus datos (productos, ventas, gastos y configuración). Esta acción no se puede deshacer.
        </p>
        {showResetConfirm ? (
