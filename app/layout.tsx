...
export const metadata: Metadata = {
  ...
  description: 'Jamón de cebo de campo 75% raza ibérica, cortado a cuchillo y envasado al vacío. Pack de 5 sobres de 100g por 37€.',
  metadataBase: new URL(siteUrl),
  alternates: { canonical: '/' },
  openGraph: { type: 'website', locale: 'es_ES', siteName: 'Ibéricos Gourmet', title: 'Jamón Ibérico Cebo de Campo 75%', description: 'Pack de 5 sobres de 100g, cortado a cuchillo. 37€.', url: siteUrl },
