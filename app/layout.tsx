...
export const metadata: Metadata = {
  title: 'Cómo vender por WhatsApp sin tienda online | Curso por 3€',
  description:
  ...
  openGraph: {
    ...
    description:
      'Aprende a vender por WhatsApp sin web, sin seguidores, sin stock y con 3€/día en publicidad. Curso online por 3€.',
    type: 'website',
    locale: 'es_ES',
