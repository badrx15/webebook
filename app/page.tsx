          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start"><a href="#productos" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-red-700 text-white font-semibold text-base hover:bg-red-800 shadow-xl shadow-red-700/25">Comprar por {formatCurrency(product.price)}</a><a href="#calidad" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full border-2 border-gray-200 text-gray-700 font-semibold text-base hover:border-red-200 hover:text-red-700">Nuestra Calidad</a></div>
