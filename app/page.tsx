      ...
      <section id="contacto" className="py-20 lg:py-28 bg-gradient-to-br from-red-700 to-red-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="https://wa.me/34614070656?text=¡Hola!%20Quiero%20más%20información%20sobre%20sus%20productos%20ibéricos."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full border-2 border-white/30 text-white font-semibold text-base hover:bg-white/10 hover:border-green-400 transition-all active:scale-95">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://wa.me/34614070656" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    💬 +34 614 070 656
                  </a>
                </li>
